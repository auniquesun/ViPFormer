...
pueue add -g vipformer_ft python ft_cls.py --proj_name Model_mp_pt_ft \
                    --mp \
                    --modality both \
                    --exp_name MP-Both-E1CL6SL-H4D256-L128-MR4-MN-0 --main_program ft_cls.py \
                    --model_name partseg.py --resume --pc_model_file runs/Model_mp_pt/Both-E1CL6SL-H4D256-L128-MR4-0/models/pc_model_best.pth \
...
pueue add -g vipformer_ft python ft_cls.py --proj_name Model_mp_pt_ft \
                    --mp \
                    --modality both \
                    --exp_name MP-Both-E1CL6SL-H4D256-L128-MR4-SO-0 --main_program ft_cls.py \
                    --model_name partseg.py --resume --pc_model_file runs/Model_mp_pt/Both-E1CL6SL-H4D256-L128-MR4-0/models/pc_model_best.pth \
