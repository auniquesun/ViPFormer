...
pueue add -g vipformer_ft python ft_cls.py --proj_name Model_mp_pt_ft \
                    --mp \
                    --modality both \
                    --exp_name MP-Both-E1CL6SL-H4D256-L96-MR2-MN-0 --main_program ft_cls.py \
                    --model_name partseg.py --resume --pc_model_file runs/Model_mp_pt/Both-E1CL6SL-H4D256-L96-MR2-0/models/pc_model_best.pth \
                    ...
                    --group_size 32 \
                    --num_ca_heads 4 --num_ca_layers 1 --mlp_widen_factor 2 --num_sa_heads 4 --num_sa_layers 6 \
...
pueue add -g vipformer_ft python ft_cls.py --proj_name Model_mp_pt_ft \
                    --mp \
                    --modality both \
                    --exp_name MP-Both-E1CL6SL-H4D256-L96-MR2-SO-0 --main_program ft_cls.py \
                    --model_name partseg.py --resume --pc_model_file runs/Model_mp_pt/Both-E1CL6SL-H4D256-L96-MR2-0/models/pc_model_best.pth \
