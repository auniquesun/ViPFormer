...
pueue add -g vipformer_ft python ft_cls.py --proj_name Model_mp_pt_ft \
                    --mp \
                    --modality both \
                    --exp_name MP-Both-E1CL8SL-H4D256-L96-MR4-MN-0 --main_program ft_cls.py \
                    --model_name partseg.py --resume --pc_model_file runs/Model_mp_pt/Both-E1CL8SL-H4D256-L96-MR4-0/models/pc_model_best.pth \
                    ...
                    --num_ft_points 1024 --num_pc_latents 96 --num_latent_channels 256 \
                    --group_size 32 \
                    --num_ca_heads 4 --num_ca_layers 1 --mlp_widen_factor 4 --num_sa_heads 4 --num_sa_layers 8 \
...
pueue add -g vipformer_ft python ft_cls.py --proj_name Model_mp_pt_ft \
                    --mp \
                    --modality both \
                    --exp_name MP-Both-E1CL8SL-H4D256-L96-MR4-SO-0 --main_program ft_cls.py \
                    --model_name partseg.py --resume --pc_model_file runs/Model_mp_pt/Both-E1CL8SL-H4D256-L96-MR4-0/models/pc_model_best.pth \
