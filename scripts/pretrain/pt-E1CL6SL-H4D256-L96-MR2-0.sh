...
# `Both-E1CL6SL-H4D256-L96-MR2-0` 实验受到了GPU占用不均衡的影响，所以跑的不正常，重开任务 `Both-E1CL6SL-H4D256-L96-MR2-1`

pueue add -g vipformer_pt python pretrain.py --proj_name Model_mp_pt \
                    --mp \
                    --modality both \
                    --exp_name Both-E1CL6SL-H4D256-L96-MR2-1 --main_program pretrain.py \
                    --model_name partseg.py --batch_size 384 --test_batch_size 384 \
