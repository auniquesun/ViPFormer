...
pueue add -g vipformer_pt python pretrain.py --proj_name Model_mp_pt \
                    --mp \
                    --modality both \
                    --exp_name Both-E1CL8SL-H4D256-L128-MR4-0 --main_program pretrain.py \
                    --model_name partseg.py --batch_size 306 --test_batch_size 306 \
                    ...
                    --num_pt_points 2048 --num_test_points 1024 --num_pc_latents 128 --num_img_latents 128 --num_latent_channels 256 \
                    --group_size 32 \
